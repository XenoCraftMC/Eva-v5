...
const wolfram_alpha_id = process.env.WOLFRAMALPHAappID;
var name = "ask"
module.exports = class AskCommand extends commando.Command {
    ...
    async run(msg, args) {
        ...
        if (args.length < 1) {
            msg.reply("Add a question to your command, so I can get an answer for you :eyes:\nEg: `xask what is the velocity of a Boeing 747`");
        }
        else {

            // Necessary for choosing random colours for rich embeds
          //  var colour_array = ["1211996", "0347003", "3089792", "1711858", "1088163", "1098851", "1050962"]
        var colour_array = []
            var randomNumber = getRandomNumber(0, 16777214);
