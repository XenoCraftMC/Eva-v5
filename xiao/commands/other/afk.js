...
module.exports = class AFKCommand extends Command {
  ...
  run(message, args) {
    if (afkUsers[message.author.id]) {
      ...
      message.reply('This message is normal to see if this is your first time using this command. If so, rerun the command. However, if this is not your first time running this command, then please contact a Developer on the Support Server.');
    }
  }
};
