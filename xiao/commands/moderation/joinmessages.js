...
module.exports = class JoinMessagesCommand extends Command {
  ...
  run (msg, {channel, option}) {
    ...
    const joinMsgEmbed = new MessageEmbed(),
      description = option ? '📈 Eva join messages have been enabled' : '📈 Eva join messages have been disabled',
    ...
    if (msg.guild.settings.get('modlogs', true)) {
      ...
      modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: joinMsgEmbed}) : null;
    }
