...
module.exports = class TempBanCommand extends Command {
  ...
  run (msg, {member, time, reason, keepmessages = false}) {
    ...
    if (msg.guild.settings.get('modlogs', true)) {
      ...
      modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: banEmbed}) : null;
    }
    ...
    setTimeout(() => {
      ...
      if (msg.guild.settings.get('modlogs', true)) {
        ...
        modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: unbanEmbed}) : null;
      }
