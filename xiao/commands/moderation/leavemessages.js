...
module.exports = class LeaveMessagesCommand extends Command {
  ...
  run (msg, {channel, option}) {
    ...
    const leaveMsgEmbed = new MessageEmbed(),
      description = option ? '📉 Eva leave messages have been enabled' : '📉 Eva leave messages have been disabled',
    ...
    if (msg.guild.settings.get('modlogs', true)) {
      ...
      modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: leaveMsgEmbed}) : null;
    }
