  ...
  run (msg, {body}) {
    try {
      ...
      if (msg.guild.settings.get('announcechannel')) {
        newsChannel = msg.guild.channels.cache.find(c => c.id === msg.guild.settings.get('announcechannel'));
      } else {
        msg.guild.channels.cache.find(c => c.name === 'announcements')
          ? newsChannel = msg.guild.channels.cache.find(c => c.name === 'announcements')
          : newsChannel = msg.guild.channels.cache.find(c => c.name === 'news');
      }
      ...
      if (msg.guild.settings.get('modlogs', true)) {
        ...
        modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: announceEmbed}) : null;
      }
