  ...
  async run (msg, {lockrole}) {
    ...
    const modlogChannel = msg.guild.settings.get('modlogchannel',
      ...
      overwrite = await msg.channel.overwritePermissions({
        overwrites: [
          {
            id: msg.guild.roles.cache.find(n => lockrole === 'everyone' ? n.name === '@everyone' : n.name === lockrole.name).id,
    ...
    if (overwrite) {
      if (msg.guild.settings.get('modlogs', true)) {
        ...
        modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: unlockEmbed}) : null;
      }
