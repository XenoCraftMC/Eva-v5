    ...
    if (member.manageable) {
      ...
      try {
        ...
        if (msg.guild.settings.get('modlogs', true)) {
          ...
          modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: muteEmbed}) : null;
          this.logs = true;
        }
        ...
        if (duration) {
          setTimeout(async () => {
            ...
            this.logs ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: muteEmbed}) : null;
