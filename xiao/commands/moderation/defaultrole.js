...
module.exports = class defaultroleCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      group: 'moderation',
      aliases: ['defrole'],
      description: 'Set a default role Eva will assign to any members joining after this command',
  ...
  run (msg, {role}) {
    ...
    if (msg.guild.settings.get('modlogs', true)) {
      ...
      modlogChannel && msg.guild.settings.get('modlogs', false) ? msg.guild.channels.cache.get(modlogChannel).send('', {embed: defRoleEmbed}) : null;
    }
